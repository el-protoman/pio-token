...
import "../contracts/PioToken.sol";

contract MyTokenTest is PioToken {
    ...
    function testTokenInitialValues() public {
        Assert.equal(name(), "Padre Pio Token", "token name did not match");
        Assert.equal(symbol(), "PIO", "token symbol did not match");
